"""service model - state column

Revision ID: 11d391e35729
Revises: aff96d38c596
Create Date: 2026-04-19 15:36:17.520983
...
revision: str = '11d391e35729'
down_revision: Union[str, Sequence[str], None] = 'aff96d38c596'
...
def upgrade() -> None:
    ...
    op.add_column('services', sa.Column('state', sa.Enum('ACTIVE', 'ARCHIVED', 'PENDING', name='recordstate', native_enum=False, length=20), nullable=False, server_default="PENDING"))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_services_state'), table_name='services')
