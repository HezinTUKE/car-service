"""service model - use organization logo

Revision ID: aff96d38c596
Revises: dd6a926d0e88
Create Date: 2026-04-17 00:46:27.578093
...
revision: str = 'aff96d38c596'
down_revision: Union[str, Sequence[str], None] = 'dd6a926d0e88'
...
def upgrade() -> None:
    ...
    op.add_column('services', sa.Column('use_organization_logo', sa.Boolean(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_services_use_organization_logo'), table_name='services')
    op.drop_column('services', 'use_organization_logo')
