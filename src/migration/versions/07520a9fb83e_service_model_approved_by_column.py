"""service model - approved_by column

Revision ID: 07520a9fb83e
Revises: 11d391e35729
Create Date: 2026-04-23 00:29:43.148540
...
revision: str = '07520a9fb83e'
down_revision: Union[str, Sequence[str], None] = '11d391e35729'
...
def upgrade() -> None:
    ...
    op.add_column('services', sa.Column('approved_by', sa.String(), nullable=True))
    op.drop_index(op.f('ix_services_is_published'), table_name='services')
    op.create_index(op.f('ix_services_approved_by'), 'services', ['approved_by'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('services', sa.Column('is_published', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.drop_index(op.f('ix_services_approved_by'), table_name='services')
