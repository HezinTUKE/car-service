...
def upgrade() -> None:
    ...
    sa.Column('country', sa.Enum('SLOVAKIA', 'CZECHIA', 'AUSTRIA', 'POLAND', 'HUNGARY', name='country', native_enum=False, length=50), nullable=False),
    ...
    op.create_index(op.f('ix_organization_identification_number'), 'organization', ['identification_number'], unique=False)
    ...
    sa.Column('role', sa.Enum('ADMIN', 'MODERATOR', 'USER', 'MASTER', name='roles', native_enum=False, length=50), server_default='USER', nullable=False),
    ...
    sa.Column('name', sa.Enum('MAINTENANCE', 'REPAIR', 'DIAGNOSTICS', 'ELECTRICAL', 'BODY_WORK', name='offertype', native_enum=False, length=50), nullable=False),
    sa.Column('car_type', sa.Enum('CLASSIC', 'SPORTS', 'ELECTRICAL', 'SUV', 'TRUCK', 'HYBRID', 'BUS', name='cartype', native_enum=False, length=50), nullable=False),
    sa.Column('currency', sa.Enum('USD', 'EUR', 'PLN', 'GBP', 'CZK', 'HUF', name='currency', native_enum=False, length=20), nullable=False),
    ...
    op.create_index(op.f('ix_offers_estimated_duration_minutes'), 'offers', ['estimated_duration_minutes'], unique=False)
