"""service model - changed column name, unique indexes for descriptions models

Revision ID: dd6a926d0e88
Revises: 803495c725c8
Create Date: 2026-04-16 00:35:36.789741
...
revision: str = 'dd6a926d0e88'
down_revision: Union[str, Sequence[str], None] = '803495c725c8'
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_offer_description_language', 'offer_description', ['offer_id', 'language_code'])
    op.create_unique_constraint('uq_organization_description_language', 'organization_description', ['organization_id', 'language_code'])
    op.create_unique_constraint('uq_service_description_language', 'service_description', ['service_id', 'language_code'])
    op.add_column('services', sa.Column('user_id', sa.String(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('services', sa.Column('owner', sa.UUID(), autoincrement=False, nullable=False))
    ...
    op.drop_constraint('uq_service_description_language', 'service_description', type_='unique')
    op.drop_constraint('uq_organization_description_language', 'organization_description', type_='unique')
    op.drop_constraint('uq_offer_description_language', 'offer_description', type_='unique')
