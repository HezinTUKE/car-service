...
from sqlalchemy import UUID, ForeignKey, Boolean, Integer, UniqueConstraint, String
...
class ReservationModel(Base):
    ...
    schedule_id: Mapped[str] = mapped_column(
        UUID(as_uuid=False), ForeignKey("schedule.schedule_id"), nullable=False, index=True
    )
